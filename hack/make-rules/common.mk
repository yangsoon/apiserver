...
# This Makefile is a copy with modifications from https://github.com/marmotedu/iam/blob/master/scripts/make-rules/common.mk
...
BLOCKER_TOOLS ?= gsemver golines golangci-lint addlicense goimports codegen
CRITICAL_TOOLS ?= swagger mockgen cfssl go-gitlint
TRIVIAL_TOOLS ?= depth
